...
const Features: React.FC = () => {
  const features = [
    ...
    { icon: Rocket, title: 'Upskilling', description: 'Continuously learning and improving skills to stay up-to-date with the latest technologies' },
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid md:grid-cols-3 gap-8">
          {features.map((feature) => (
            <div 
              key={feature.title}
              className="bg-white/5 backdrop-blur-lg rounded-lg p-6 border border-white/10 hover:bg-white/10 transition-colors duration-300 hover:shadow-lg hover:shadow-purple-400/20"
            >
